...
PDFJS.imageResourcesPath = './assets/js/pdf/images/';
PDFJS.workerSrc = './assets/js/pdf/lib/pdf.worker.js';
PDFJS.cMapUrl = './assets/js/pdf/cmaps/';
...
var PresentationMode = {
    ...
    request: function presentationModeRequest() {
        if (!PDFViewerApplication.supportsFullscreen || this.isFullscreen || !this.viewer.hasChildNodes()) {
            return false;
        }
...
var PDFViewerApplication = {
    ...
    setTitleUsingUrl: function pdfViewSetTitleUsingUrl(url) {
        this.url = url;
        try {
           //  this.setTitle(decodeURIComponent(getFileName(url)) || url);  TODO yufei
        } catch (e) {
...
function webViewerInitialized() {
    ...
    var file = 'file' in params ? decodeURIComponent(params.file) : DEFAULT_URL;
...
window.addEventListener('keydown', function keydown(evt) {
    ...
    if (!handled && !PresentationMode.active) {
        ...
        if (evt.keyCode >= 33 && evt.keyCode <= 40 && !PDFViewerApplication.pdfViewer.containsElement(curElement)) {
